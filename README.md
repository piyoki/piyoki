...
> Git, Jenkins, Ansible, Terraform, CircleCI, Tekton, Argo, OpenShift
...
> Service Mesh, Mesh Gateways, Consul, Istios, Linkerd, Envoy, HAproxy, Nginx, Trafik, Helm, Keel (Automation tool for Kubernetes deployment updates), Argo CI/CD, Tekton CI/CD, Kafka (Stream Processing), Harbor (Private Container Repository), Longhorn (Cloud Native Distributed Storage), Buildpack, Kaniko (Container Image Builder), FluentBit, Fluentd (Log Management), Knative, KubeFlow, KubeEdge, Nvidia Operator

...
> JaveScript, HTML, CSS, C, C++, #C, Bash, Groovy, Python, Golang, YAML, JSON, Ruby, DB， Markdown
...
> Service Mesh, Istios, Linkerd, Envoy, HAproxy, Nginx, Trafik, Helm, Keel (Automation tool for Kubernetes deployment updates ), Harbor (Private Container Repository), Longhorn (Cloud Native Distributed Storage)
